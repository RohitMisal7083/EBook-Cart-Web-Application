	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<c:if test="${not empty userobj }">
				<a class="btn btn-success tsxt-white"><i
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active "><a class="nav-link"
				href="add_books.jsp"> <i class="fa-solid fa-plus"></i> Add Book
			</a></li>

			<li class="nav-item active "><a class="nav-link"
				href="all_books.jsp"> <i class="fa-solid fa-book-open"></i> All
					Books
			</a></li>

			<li class="nav-item active "><a class="nav-link"
				href="orders.jsp"> <i class="fa-solid fa-box-open"></i> Order
					Book
			</a></li>
